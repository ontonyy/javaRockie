...
public class WindowsComputer implements Computer {
    ...
    public WindowsComputer(Keyboard keyboard, Screen screen, Mouse mouse, GraphicCard graphicCard, Memory memory, Motherboard motherboard, Processor processor, int usbAmount) {
    ...
    public void playGames() {
        System.out.println(graphicCard.toString() + " turn on to work.");
    }
}
